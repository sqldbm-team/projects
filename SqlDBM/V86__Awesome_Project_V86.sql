-- ************************** SqlDBM: Snowflake **************************
-- * Generated by SqlDBM: Awesome Project, v86 by hazal.sener@sqldbm.com *
...
(
 ...
 CONSTRAINT "FK_${ParentTableName}_${TableName}" FOREIGN KEY ( DateKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimDate ( DateKey ),
 CONSTRAINT "FK_${ParentTableName}_${TableName}" FOREIGN KEY ( ProductCategoryKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimProductCategory ( ProductCategoryKey )
);
...
(
 ...
 CONSTRAINT PK_DimEmployee_sqldbm_DimEmployee PRIMARY KEY ( EmployeeKey ),
