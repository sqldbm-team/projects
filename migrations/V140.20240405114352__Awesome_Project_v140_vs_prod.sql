-- *********************************** SqlDBM: Snowflake **********************************
-- * Generated by SqlDBM: Awesome Project, v140 vs prod by daniel.jimenez+team@sqldbm.com *
...
DROP TABLE EDW.FactProductInventory;
...
DROP TABLE HOTELBNB.DESTINATIONS;

DROP TABLE EDW.ChildDemo_Test;

DROP TABLE HOTELBNB.BOOKINGS;

DROP FUNCTION HOTELBNB.VALIDATE_ID(float);

DROP VIEW EDW.DIM_PRODUCT_CAT_SUBCAT_V;

CREATE SCHEMA SFLK_DATA;
