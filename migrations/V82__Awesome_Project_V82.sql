-- ************************** SqlDBM: Snowflake **************************
-- * Generated by SqlDBM: Awesome Project, v82 by hazal.sener@sqldbm.com *
...
-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimOrganization
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimOrganization
(
...
-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimGeography
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimGeography
(
...
-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_FactSurveyResponse
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_FactSurveyResponse
(
 ...
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( DateKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimDate ( DateKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( ProductCategoryKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimProductCategory ( ProductCategoryKey )
);
...
(
 ...
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( DateKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimDate ( DateKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( OrganizationKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimOrganization ( OrganizationKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( DepartmentGroupKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimDepartmentGroup ( DepartmentGroupKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( ScenarioKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimScenario ( ScenarioKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( AccountKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimAccount ( AccountKey )
)
...
-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimReseller
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimReseller
(
 ...
 CONSTRAINT FK_sqldbm_DimGeography_sqldbm_DimReseller FOREIGN KEY ( GeographyKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimGeography ( GeographyKey )
);

-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimProductSubcategory
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimProductSubcategory
(
 ...
 CONSTRAINT FK_sqldbm_DimProductCategory_sqldbm_DimProductSubcategory FOREIGN KEY ( ProductCategoryKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimProductCategory ( ProductCategoryKey )
);

-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimEmployee
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimEmployee
(
 ...
 CONSTRAINT FK_sqldbm_DimEmployee_sqldbm_DimEmployee FOREIGN KEY ( ParentEmployeeKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimEmployee ( EmployeeKey ),
 CONSTRAINT FK_sqldbm_DimSalesTerritory_sqldbm_DimEmployee FOREIGN KEY ( SalesTerritoryKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimSalesTerritory ( SalesTerritoryKey )
)
...
-- ************************************** "ADVENTUREWORKSDW.EDW".sqldbm_DimProduct
CREATE TABLE "ADVENTUREWORKSDW.EDW".sqldbm_DimProduct
(
 ...
 CONSTRAINT FK_sqldbm_DimProductSubcategory_sqldbm_DimProduct FOREIGN KEY ( ProductSubcategoryKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimProductSubcategory ( ProductSubcategoryKey )
);
...
(
 ...
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( ResellerKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimReseller ( ResellerKey ),
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_FactInternetSales FOREIGN KEY ( EmployeeKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimEmployee ( EmployeeKey ),
...
(
 ...
 CONSTRAINT FK_sqldbm_DimProduct_sqldbm_sold FOREIGN KEY ( ProductKey ) REFERENCES "ADVENTUREWORKSDW.EDW".sqldbm_DimProduct ( ProductKey )
)
